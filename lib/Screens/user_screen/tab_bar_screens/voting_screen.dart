...
class VotingScreen extends StatefulWidget {
  ...
  const VotingScreen({super.key, required this.userDistrict});
            ...
            builder: (context, snapshot) {
              ...
              return FutureBuilder<List<String>>(
                ...
                builder: (context, userVotesSnapshot) {
                  ...
                  final mnaCandidates = candidates
                      .where((c) =>
                          c['candidateRole'] == 'Minister Of National Assembly')
                      .toList();
                  final mpaCandidates = candidates
                      .where((c) =>
                          c['candidateRole'] == 'Minister Of Province Assembly')
                      .toList();
                    ...
                    child: ListView(
                      children: [
                        if (mnaCandidates.isNotEmpty) ...[
                          ...
                          ...mnaCandidates
                              .map(
                                  (candidate) => _buildCandidateCard(candidate))
                              .toList(),
                        ],
                        if (mpaCandidates.isNotEmpty) ...[
                          const Padding(
                            padding: EdgeInsets.all(8.0),
                            child: Text(
                              'MPAs',
